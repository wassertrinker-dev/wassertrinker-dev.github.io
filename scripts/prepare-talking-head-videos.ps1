...
foreach ($inputFile in $inputFiles) {
  ...
  $manifestRows.Add("| $OutputDirectory/$fileName | $duration s | $($outputVideo.width)x$($outputVideo.height) | H.264/AAC MP4 | $sourceSize B -> $outputSize B ($sizeChange% smaller) | $SourceDescription | $UsageRights | AI generated or AI modified | AI burned in at bottom right | Loaded on demand at the matching German workflow scene; no initial video source |")
